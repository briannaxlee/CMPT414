...
class DisplayBlock(pygame.sprite.Sprite):
    HEIGHT = 40
    WIDTH = 100
    def __init__(self):
        super().__init__()
        self.image = pygame.Surface([DisplayBlock.WIDTH, DisplayBlock.HEIGHT])
        self.image.fill(BLUE)
        self.rect = self.image.get_rect()
        self.rect.x = SCREEN_WIDTH - 700
        self.rect.y = SCREEN_HEIGHT - DisplayBlock.HEIGHT
...
class Game(object):
    ...
    def __init__(self):
        ...
        blueBlock = DisplayBlock()
        self.all_sprites_list.add(blueBlock)
    ...
    def display_feedback(self, screen):
        ...
        center_x = (SCREEN_WIDTH - 695)
        center_y = (SCREEN_HEIGHT - DisplayBlock.HEIGHT // 2) - (text.get_height() // 2)
        screen.blit(text, [center_x, center_y])
...
def main():
    ...
    pygame.display.set_caption("Brianna Lee - Lab 7")
