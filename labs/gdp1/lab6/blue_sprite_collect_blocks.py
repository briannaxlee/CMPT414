...
class Block(pygame.sprite.Sprite):
    ...
    def __init__(self, color):
        ...
        # Set a random location for the color
...
class BlueBlock(Block):
    def __init__(self, newBlock):
        ...
        self.rect.x = newBlock.rect.x
        self.rect.y = newBlock.rect.y
...
pygame.display.set_caption("Lab 6 - Brianna Lee")
...
while not done:
    ...
    for block in blocks_hit_list:
        collideBlock = BlueBlock(block)
        all_sprites_list.add(collideBlock)
